<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Globomantics.Framework._Default" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">

    <section class="banner">
    <img src="/Content/images/hero image.png"/>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-4 col-md-4 adj_text">
                ...
                <img src="/Content/images/Bitmap.png" alt="Public Adjuster"/>
            ...
            <div class="col-xs-12 col-sm-4 col-md-4 adj_text">
                ...
                <img src="/Content/images/Bitmap(1).png" alt="Public"/>
                <div class="read-more-btn">
            ...
            <div class="col-xs-12 col-sm-4 col-md-4 adj_text">
                ...
                <img src="/Content/images/shutterstock_211091626.png" alt="Public"/>
                <div class="read-more-btn">
                    <a href="#" class="btn-oval">Learn More</a>
